...
def simulate_reading(driver, btn_comment=None):
    """
    ...
    """
    # 1. 목표 체류시간 자동 생성
    target_duration = random.uniform(TOTAL_STAY_DURATION_MIN, TOTAL_STAY_DURATION_MAX)
